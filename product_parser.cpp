...
{
	Product* new_book = new Book("Book", prodName_, price_, qty_, author_, isbn_);
	return new_book;
}
...
{
	Product* new_clothing = new Clothing("Clothing", prodName_, price_, qty_, size_, brand_);
	return new_clothing;
}
...
{
    Product * new_movie = new Movie("Movie", prodName_, price_, qty_, genre_, rating_);
    return new_movie;
}
